...
<div class="item-index">
    ...
    echo Html::a('Восстановить выбранные', ['multi-restore'], [
    ...
    echo Html::a('Сменить материальноответственного', ['transfer-item-multi'], [
    ...
    echo Html::a('Сменить корпус/кабинет', ['multi-update-corps-cabinet'], [
    ...
    echo Html::a('Сменить категорию', ['multi-update-category'], [
    ...
    echo Html::a('Сменить Статус', ['multi-update-status'], [
