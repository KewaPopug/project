 ...
 * 'controllerMap' => [
 *     'assignment' => [
 *         'class' => 'app\modules\adminPanel\controllers\AssignmentController',
...
class Module extends \yii\base\Module
{
     ...
     * Its used when `layout` set to 'left-menu', 'right-menu' or 'top-menu'.
     */
    public $mainLayout = '@app/modules/adminPanel/views/layouts/main.php';
    /**
     * @var array
     * @see [[menus]]
     */
    ...
    public function getMenus()
    {
        if ($this->_normalizeMenus === null) {
            ...
            $config = \mdm\admin\components\Configs::instance();
            $conditions = [
